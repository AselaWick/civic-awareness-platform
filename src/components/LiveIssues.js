...
const LiveIssues = () => {
    ...
    return (_jsxs("div", { className: "bg-gray-100 p-4 rounded shadow-md mb-6", children: [_jsx("h2", { className: "text-xl font-semibold mb-4", children: "Live Issues" }), loading ? (_jsx("p", { className: "text-sm text-gray-600", children: "Loading issues..." })) : issues.length === 0 ? (_jsx("p", { className: "text-sm text-gray-600", children: "No issues reported yet." })) : (_jsxs("div", { className: "flex flex-col lg:flex-row gap-6", children: [_jsx("div", { className: "mb-4", children: _jsx("input", { type: "text", placeholder: "Search by location, title, or description...", value: searchQuery, onChange: e => setSearchQuery(e.target.value), className: "w-full lg:w-1/2 px-4 py-2 border border-gray-300 rounded shadow-sm text-sm" }) }), _jsx("div", { className: "lg:w-1/2 overflow-x-auto", children: _jsxs("table", { className: "min-w-full bg-white border border-gray-300 rounded", children: [_jsx("thead", { className: "bg-gray-100", children: _jsxs("tr", { children: [_jsx("th", { className: "px-4 py-2 text-left text-sm font-semibold text-gray-700", children: "Title" }), _jsx("th", { className: "px-4 py-2 text-left text-sm font-semibold text-gray-700", children: "Description" }), _jsx("th", { className: "px-4 py-2 text-left text-sm font-semibold text-gray-700", children: "Location" }), _jsx("th", { className: "px-4 py-2 text-left text-sm font-semibold text-gray-700", children: "Upvotes" }), _jsx("th", { className: "px-4 py-2 text-left text-sm font-semibold text-gray-700", children: "Downvotes" }), _jsx("th", { className: "px-4 py-2 text-left text-sm font-semibold text-gray-700", children: "Actions" })] }) }), _jsx("tbody", { children: filteredIssues.length === 0 ? (_jsx("tr", { children: _jsx("td", { colSpan: 6, className: "px-4 py-2 text-sm text-gray-500 text-center", children: "No matching issues found." }) })) : (filteredIssues.map(issue => {
                                        ...
                                        return (_jsxs("tr", { className: `border-t border-gray-200 ${isMapVisible ? 'bg-blue-50' : ''}`, children: [_jsx("td", { className: "px-4 py-2 text-sm text-gray-800", children: issue.title }), _jsx("td", { className: "px-4 py-2 text-sm text-gray-800", children: issue.description }), _jsx("td", { className: "px-4 py-2 text-sm text-gray-800", children: displayLocation }), _jsx("td", { className: "px-4 py-2 text-sm text-gray-800", children: issue.upvotes }), _jsx("td", { className: "px-4 py-2 text-sm text-gray-800", children: issue.downvotes }), _jsx("td", { className: "px-4 py-2 text-sm text-gray-800", children: _jsx(VoteButtons, { issueId: issue.id, currentUpvotes: issue.upvotes, currentDownvotes: issue.downvotes }) })] }, issue.id));
